...
class FileUploadServiceTest {
	...
	private final String expectedJson = "{\"id\":1476265357000,\"timeInSeconds\":5641,\"distanceInKm\":15.71,\"avgHeartBeat\":154,\"maxHeartBeat\":196,\"trainingEffect\":\"41\",\"anaerobTrainingEffect\":\"-\",\"pace\":\"10.0\"}";
	...
	public void testUploadFile() throws IOException {
		...
		final MultivaluedMap<String, String> headers = Mockito.mock(MultivaluedMap.class);
